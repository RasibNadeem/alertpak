    ...
    getAllCategories = async ()=> {
        ...
        if(!this._isMounted){
            ...
            if(response.status=== 200){
                this.setState({categories: response.data.categories, spinning: false});
            }
        }
                ...
                <Row>
                    <Colxx xxs="12">
                        ...
                        <div className="text-zero top-right-button-container">
                            <Link to='/app/categories/create'><Button size='lg' color={'secondary'}><IntlMessages id={"menu.create"} /></Button></Link>
                        </div>
                                                ...
                                                {(rowData, rowIndex) => {
                                                    return <div>
                                                        ...
                                                        <Button color="secondary" size="xs" className="mb-2">
                                                            <Link to={`/app/categories/edit/${rowData._id}`} style={{color: 'white'}}><IntlMessages id="edit" /></Link>
                                                        </Button>}
                                                        {" "}{" "}
